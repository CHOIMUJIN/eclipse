...
//				+person.getPname() + "', " + person.getPage() + ") "; // 문자열 sql은 "" 사이에 두 번 띄어쓰고 만드는 습관 들이기 !
//		try {
//			// 커넥션 통해서 Statement 생성
//			stmt = conn.createStatement();
//			// 쿼리 실행하고 결과를 불리언으로 변환
//			stmt.execute(sql);
...
//		Statement stmt = null;
//		// SQL : Structured Query Language (데이터베이스에 보내는 문장)
//		String sql = " update person set pname='" // 문자열 sql은 "" 사이에 두 번 띄어쓰고 만드는 습관 들이기 !
