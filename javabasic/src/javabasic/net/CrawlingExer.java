...
public class CrawlingExer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			File file = new File("C:\\Users\\Administrator\\git\\githubTest\\javabasic\\src\\assets\\rice.txt");
			...
			while ((readedLine=br.readLine()) != null) {
				...
				System.out.println("읽어온 행 : " + readedLine);
				...
				piList.add(new ProductInfo(prodName, Integer.parseInt(prodPrice), Integer.parseInt(prodPoint)));
